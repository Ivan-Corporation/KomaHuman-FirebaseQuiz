...
public class SplashActivity extends AppCompatActivity {
    ...
    private TextView appName; // Загрузочный экран по сути
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Typeface typeface = ResourcesCompat.getFont(this,R.font.blacklist); // Шрифт
        appName.setTypeface(typeface);

        Animation anim = AnimationUtils.loadAnimation(getApplicationContext(),R.anim.myanim);  // Анимация
        appName.setAnimation(anim);

        firestore = FirebaseFirestore.getInstance();

        new Thread() {      // Старт загрузочного экрана
            public void run() {
